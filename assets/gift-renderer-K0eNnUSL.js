...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fs(e,t,n){let r=new Float32Array(xs),i=new W(0,1,0);return new Pa({name:`SphericalGaussianBlur`,defines:{n:xs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Rs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Is(){return new Pa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Rs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ls(){return new Pa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Rs(),fragmentShader:`
	...
	`}var zs=class extends un{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new _a(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        void main(){
          ...
          #include <colorspace_fragment>
        }`}),this.mesh=new Bi(this.geometry,this.material,160),this.mesh.frustumCulled=!1,this.mesh.instanceMatrix.setUsage(ot),this.scene.add(this.mesh),this.camera.position.z=5,this.renderer.setClearColor(0,0)}draw(e){let t=Math.min(devicePixelRatio,1.5);this.renderer.getPixelRatio()!==t&&this.renderer.setPixelRatio(t),(this.renderer.domElement.width!==Math.floor(e.width*t)||this.renderer.domElement.height!==Math.floor(e.height*t))&&this.renderer.setSize(e.width,e.height),(this.camera.right!==e.width||this.camera.bottom!==e.height)&&(this.camera.left=0,this.camera.right=e.width,this.camera.top=0,this.camera.bottom=e.height,this.camera.updateProjectionMatrix());let n=0;for(let t of[!1,!0])for(let r of e.particles)if(r.state&&r.front===t){this.object.position.set(r.x,r.y,+!!t),this.object.rotation.set(0,0,r.angle);let e=Math.cos(r.flip),i=Math.max(.12,Math.abs(e))*((r.state===1?e<0:r.backFace)?-1:1);this.object.scale.set(r.w,r.h*i,1),this.object.updateMatrix();let a=Math.cos(r.tiltAxis??0),o=Math.sin(r.tiltAxis??0),s=Math.cos(r.angle),c=Math.sin(r.angle),l=a*a+i*o*o,u=(1-i)*a*o,d=o*o+i*a*a,f=this.object.matrix.elements;f[0]=(s*l-c*u)*r.w,f[1]=(c*l+s*u)*r.w,f[4]=(s*u-c*d)*r.h,f[5]=(c*u+s*d)*r.h,this.mesh.setMatrixAt(n,this.object.matrix),this.style.setXYZW(n,r.alpha,r.color%4,r.id%7/6,0),this.flip.setX(n,r.flip),n++}this.mesh.count=n,this.mesh.instanceMatrix.needsUpdate=!0,this.style.needsUpdate=!0,this.flip.needsUpdate=!0,this.renderer.render(this.scene,this.camera)}debug(e,t,n){e.save(),e.setLineDash([]),e.lineWidth=2,e.font=`12px sans-serif`;for(let r of t.surfaces.values()){e.strokeStyle=r.id===`frontHair`?`#f89cfa`:r.id===`hair`?`#70ffcd`:`#ffcf61`,e.globalAlpha=r.valid&&n-r.timestamp<250?1:.3,e.beginPath();for(let[t,n,a,o]of r.segments){let s=i({x:t,y:n},r.frame),c=i({x:a,y:o},r.frame);e.moveTo(s.x,s.y),e.lineTo(c.x,c.y)}e.stroke()}e.globalAlpha=1,e.strokeStyle=`#f89cfa`;for(let n of t.hands)for(let r of[[0,5,6,7,8],[0,9,10,11,12],[0,13,14,15,16],[0,17,18,19,20]])e.beginPath(),r.forEach((r,i)=>{let a=t.map(n[r*3],n[r*3+1]);i?e.lineTo(a.x,a.y):e.moveTo(a.x,a.y)}),e.stroke();e.fillStyle=`#fff`;for(let n of t.particles)n.state&&(e.fillText(`${n.id}${n.state===2?`·`:``}`,n.x+5,n.y),e.beginPath(),e.moveTo(n.px,n.py),e.lineTo(n.x,n.y),e.stroke());e.fillStyle=`rgba(0,0,0,.65)`,e.fillRect(10,65,Math.min(245,t.width-20),95),e.fillStyle=`#fff`,e.fillText(`P50 ${t.p50.toFixed(1)} ms / P95 ${t.p95.toFixed(1)} ms · ${t.active} 颗 / 接触 ${t.contacts} / 轮次 ${t.rounds} · 固定预算`,16,84),t.frontHairEnabled&&(e.fillStyle=`rgba(0,0,0,.65)`,e.fillRect(10,165,Math.min(380,t.width-20),26),e.fillStyle=`#f89cfa`,e.fillText(`发区验证 · 粉色短线为稳定发区内落点 · 未通过真人验收`,16,183),e.fillStyle=`#fff`);let r=t.shoulderDiagnostics;e.fillStyle=`rgba(0,0,0,.65)`,e.fillRect(10,195,Math.min(540,t.width-20),76),e.fillStyle=`#ffcf61`,e.fillText(`肩部点数：${r.leftRaw??0}/${r.rightRaw??0} → 平滑 ${r.leftFit??0}/${r.rightFit??0}`,16,212),e.fillText(`可承接上限：${t.surfaces.get(`left`)?.capacity??0}/${t.surfaces.get(`right`)?.capacity??0} · ${r.status===`fresh`?`结果新鲜`:r.status===`hair stale`?`等待头发更新`:`等待肩部识别`}`,16,228),e.fillText(`本轮肩部：投向 ${t.shoulderLaunches.left}/${t.shoulderLaunches.right} · 已落 ${t.landed.left??0}/${t.landed.right??0} · 失效淡出 ${t.shoulderLosses}`,16,244),e.fillText(`未生成原因：${r.leftReason??`等待`} / ${r.rightReason??`等待`}`,16,260),e.fillStyle=`#fff`;let a=102;for(let[r,i]of Object.entries(t.metrics))e.fillText(`${r}: ${i.valid?`有效`:`无有效区域`} · ${Math.round(n-i.timestamp)} ms 前 · 耗时 ${i.duration.toFixed(1)} ms`,16,a),a+=15;e.restore()}dispose(){this.mesh.dispose(),this.geometry.dispose(),this.material.dispose(),this.ramp.dispose(),this.shared||(this.renderer.dispose(),this.renderer.forceContextLoss())}};function Du(e,t){let n=new Map,r=new Map;for(let i of t.tracks){let t=X.parseTrackName(i.name),a=X.findNode(e,t.nodeName);if(a instanceof zn){if(t.propertyName===`scale`){let e=0;for(let t of i.values)e=Math.max(e,Math.abs(t));n.set(a,e)}else if(t.propertyName===`position`){let e=0;for(let t=0;t<i.values.length;t+=3)e=Math.max(e,Math.hypot(i.values[t],i.values[t+1],i.values[t+2]));r.set(a,e)}}}function i(e){let t=0;if(e instanceof mi){e.geometry.computeBoundingSphere();let n=e.geometry.boundingSphere;n&&(t=n.center.length()+n.radius)}for(let n of e.children)t=Math.max(t,i(n));let a=Math.max(n.get(e)??0,Math.abs(e.scale.x),Math.abs(e.scale.y),Math.abs(e.scale.z));return t*a+Math.max(r.get(e)??0,e.position.length())}return Math.max(.01,i(e))*1.01}function Ou(e,t){if(t===0)return console.warn(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles.`),e;if(t===2||t===1){let n=e.getIndex();if(n===null){let t=[],r=e.getAttribute(`position`);if(r!==void 0){for(let e=0;e<r.count;e++)t.push(e);e.setIndex(t),n=e.getIndex()}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible.`),e}let r=n.count-2,i=[];if(t===2)for(let e=1;e<=r;e++)i.push(n.getX(0)),i.push(n.getX(e)),i.push(n.getX(e+1));else for(let e=0;e<r;e++)e%2==0?(i.push(n.getX(e)),i.push(n.getX(e+1)),i.push(n.getX(e+2))):(i.push(n.getX(e+2)),i.push(n.getX(e+1)),i.push(n.getX(e)));i.length/3!==r&&console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.`);let a=e.clone();return a.setIndex(i),a.clearGroups(),a}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:`,t),e}function ku(e){let t=new Map,n=new Map,r=e.clone();return Au(e,r,function(e,r){t.set(r,e),n.set(e,r)}),r.traverse(function(e){if(!e.isSkinnedMesh)return;let r=e,i=t.get(e),a=i.skeleton.bones;r.skeleton=i.skeleton.clone(),r.bindMatrix.copy(i.bindMatrix),r.skeleton.bones=a.map(function(e){return n.get(e)}),r.bind(r.skeleton,r.bindMatrix)}),r}function Au(e,t,n){n(e,t);for(let r=0;r<e.children.length;r++)Au(e.children[r],t.children[r],n)}var ju=class extends lo{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(e){return new Lu(e)}),this.register(function(e){return new Ru(e)}),this.register(function(e){return new qu(e)}),this.register(function(e){return new Ju(e)}),this.register(function(e){return new Yu(e)}),this.register(function(e){return new Bu(e)}),this.register(function(e){return new Vu(e)}),this.register(function(e){return new Hu(e)}),this.register(function(e){return new Uu(e)}),this.register(function(e){return new Iu(e)}),this.register(function(e){return new Wu(e)}),this.register(function(e){return new zu(e)}),this.register(function(e){return new Ku(e)}),this.register(function(e){return new Gu(e)}),this.register(function(e){return new Pu(e)}),this.register(function(e){return new Xu(e,$.EXT_MESHOPT_COMPRESSION)}),this.register(function(e){return new Xu(e,$.KHR_MESHOPT_COMPRESSION)}),this.register(function(e){return new Zu(e)})}load(e,t,n,r){let i=this,a;if(this.resourcePath!==``)a=this.resourcePath;else if(this.path!==``){let t=Ro.extractUrlBase(e);a=Ro.resolveURL(t,this.path)}else a=Ro.extractUrlBase(e);this.manager.itemStart(e);let o=function(t){r?r(t):console.error(t),i.manager.itemError(e),i.manager.itemEnd(e)},s=new po(this.manager);s.setPath(this.path),s.setResponseType(`arraybuffer`),s.setRequestHeader(this.requestHeader),s.setWithCredentials(this.withCredentials),s.load(e,function(n){try{i.parse(n,a,function(n){t(n),i.manager.itemEnd(e)},o)}catch(e){o(e)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,r){let i,a={},o={},s=new TextDecoder;if(typeof e==`string`)i=JSON.parse(e);else if(e instanceof ArrayBuffer)if(s.decode(new Uint8Array(e,0,4))===Qu){try{a[$.KHR_BINARY_GLTF]=new td(e)}catch(e){r&&r(e);return}i=JSON.parse(a[$.KHR_BINARY_GLTF].content)}else i=JSON.parse(s.decode(e));else i=e;if(i.asset===void 0||i.asset.version[0]<2){r&&r(Error(`THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported.`));return}let c=new Dd(i,{path:t||this.resourcePath||``,crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let e=0;e<this.pluginCallbacks.length;e++){let t=this.pluginCallbacks[e](c);t.name||console.error(`THREE.GLTFLoader: Invalid plugin found: missing name`),o[t.name]=t,a[t.name]=!0}if(i.extensionsUsed)for(let e=0;e<i.extensionsUsed.length;++e){let t=i.extensionsUsed[e],n=i.extensionsRequired||[];switch(t){case $.KHR_MATERIALS_UNLIT:a[t]=new Fu;break;case $.KHR_DRACO_MESH_COMPRESSION:a[t]=new nd(i,this.dracoLoader);break;case $.KHR_TEXTURE_TRANSFORM:a[t]=new rd;break;case $.KHR_MESH_QUANTIZATION:a[t]=new id;break;default:n.indexOf(t)>=0&&o[t]===void 0&&console.warn(`THREE.GLTFLoader: Unknown extension "`+t+`".`)}}c.setExtensions(a),c.setPlugins(o),c.parse(n,r)}parseAsync(e,t){let n=this;return new Promise(function(r,i){n.parse(e,t,r,i)})}};function Mu(){let e={};return{get:function(t){return e[t]},add:function(t,n){e[t]=n},remove:function(t){delete e[t]},removeAll:function(){e={}}}}function Nu(e,t,n){let r=e.json.materials[t];return r.extensions&&r.extensions[n]?r.extensions[n]:null}var $={KHR_BINARY_GLTF:`KHR_binary_glTF`,KHR_DRACO_MESH_COMPRESSION:`KHR_draco_mesh_compression`,KHR_LIGHTS_PUNCTUAL:`KHR_lights_punctual`,KHR_MATERIALS_CLEARCOAT:`KHR_materials_clearcoat`,KHR_MATERIALS_DISPERSION:`KHR_materials_dispersion`,KHR_MATERIALS_IOR:`KHR_materials_ior`,KHR_MATERIALS_SHEEN:`KHR_materials_sheen`,KHR_MATERIALS_SPECULAR:`KHR_materials_specular`,KHR_MATERIALS_TRANSMISSION:`KHR_materials_transmission`,KHR_MATERIALS_IRIDESCENCE:`KHR_materials_iridescence`,KHR_MATERIALS_ANISOTROPY:`KHR_materials_anisotropy`,KHR_MATERIALS_UNLIT:`KHR_materials_unlit`,KHR_MATERIALS_VOLUME:`KHR_materials_volume`,KHR_TEXTURE_BASISU:`KHR_texture_basisu`,KHR_TEXTURE_TRANSFORM:`KHR_texture_transform`,KHR_MESH_QUANTIZATION:`KHR_mesh_quantization`,KHR_MATERIALS_EMISSIVE_STRENGTH:`KHR_materials_emissive_strength`,EXT_MATERIALS_BUMP:`EXT_materials_bump`,EXT_TEXTURE_WEBP:`EXT_texture_webp`,EXT_TEXTURE_AVIF:`EXT_texture_avif`,EXT_MESHOPT_COMPRESSION:`EXT_meshopt_compression`,KHR_MESHOPT_COMPRESSION:`KHR_meshopt_compression`,EXT_MESH_GPU_INSTANCING:`EXT_mesh_gpu_instancing`},Pu=class{constructor(e){this.parser=e,this.name=$.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){let e=this.parser,t=this.parser.json.nodes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){let t=this.parser,n=`light:`+e,r=t.cache.get(n);if(r)return r;let i=t.json,a=((i.extensions&&i.extensions[this.name]||{}).lights||[])[e],o,s=new Y(16777215);a.color!==void 0&&s.setRGB(a.color[0],a.color[1],a.color[2],tt);let c=a.range===void 0?0:a.range;switch(a.type){case`directional`:o=new Lo(s),o.target.position.set(0,0,-1),o.add(o.target);break;case`point`:o=new Po(s),o.distance=c;break;case`spot`:o=new Mo(s),o.distance=c,a.spot=a.spot||{},a.spot.innerConeAngle=a.spot.innerConeAngle===void 0?0:a.spot.innerConeAngle,a.spot.outerConeAngle=a.spot.outerConeAngle===void 0?Math.PI/4:a.spot.outerConeAngle,o.angle=a.spot.outerConeAngle,o.penumbra=1-a.spot.innerConeAngle/a.spot.outerConeAngle,o.target.position.set(0,0,-1),o.add(o.target);break;default:throw Error(`THREE.GLTFLoader: Unexpected light type: `+a.type)}return o.position.set(0,0,0),yd(o,a),a.intensity!==void 0&&(o.intensity=a.intensity),o.name=t.createUniqueName(a.name||`light_`+e),r=Promise.resolve(o),t.cache.add(n,r),r}getDependency(e,t){if(e===`light`)return this._loadLight(t)}createNodeAttachment(e){let t=this,n=this.parser,r=n.json.nodes[e],i=(r.extensions&&r.extensions[this.name]||{}).light;return i===void 0?null:this._loadLight(i).then(function(e){return n._getNodeRef(t.cache,i,e)})}},Fu=class{constructor(){this.name=$.KHR_MATERIALS_UNLIT}getMaterialType(){return ni}extendParams(e,t,n){let r=[];e.color=new Y(1,1,1),e.opacity=1;let i=t.pbrMetallicRoughness;if(i){if(Array.isArray(i.baseColorFactor)){let t=i.baseColorFactor;e.color.setRGB(t[0],t[1],t[2],tt),e.opacity=t[3]}i.baseColorTexture!==void 0&&r.push(n.assignTexture(e,`map`,i.baseColorTexture,et))}return Promise.all(r)}},Iu=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){let n=Nu(this.parser,e,this.name);return n===null||n.emissiveStrength!==void 0&&(t.emissiveIntensity=n.emissiveStrength),Promise.resolve()}},Lu=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return Nu(this.parser,e,this.name)===null?null:La}extendMaterialParams(e,t){let n=Nu(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(n.clearcoatFactor!==void 0&&(t.clearcoat=n.clearcoatFactor),n.clearcoatTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatMap`,n.clearcoatTexture)),n.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=n.clearcoatRoughnessFactor),n.clearcoatRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatRoughnessMap`,n.clearcoatRoughnessTexture)),n.clearcoatNormalTexture!==void 0&&(r.push(this.parser.assignTexture(t,`clearcoatNormalMap`,n.clearcoatNormalTexture)),n.clearcoatNormalTexture.scale!==void 0)){let e=n.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new U(e,e)}return Promise.all(r)}},Ru=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_DISPERSION}getMaterialType(e){return Nu(this.parser,e,this.name)===null?null:La}extendMaterialParams(e,t){let n=Nu(this.parser,e,this.name);return n===null||(t.dispersion=n.dispersion===void 0?0:n.dispersion),Promise.resolve()}},zu=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return Nu(this.parser,e,this.name)===null?null:La}extendMaterialParams(e,t){let n=Nu(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.iridescenceFactor!==void 0&&(t.iridescence=n.iridescenceFactor),n.iridescenceTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceMap`,n.iridescenceTexture)),n.iridescenceIor!==void 0&&(t.iridescenceIOR=n.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),n.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=n.iridescenceThicknessMinimum),n.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=n.iridescenceThicknessMaximum),n.iridescenceThicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceThicknessMap`,n.iridescenceThicknessTexture)),Promise.all(r)}},Bu=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_SHEEN}getMaterialType(e){return Nu(this.parser,e,this.name)===null?null:La}extendMaterialParams(e,t){let n=Nu(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(t.sheenColor=new Y(0,0,0),t.sheenRoughness=0,t.sheen=1,n.sheenColorFactor!==void 0){let e=n.sheenColorFactor;t.sheenColor.setRGB(e[0],e[1],e[2],tt)}return n.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=n.sheenRoughnessFactor),n.sheenColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenColorMap`,n.sheenColorTexture,et)),n.sheenRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenRoughnessMap`,n.sheenRoughnessTexture)),Promise.all(r)}},Vu=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return Nu(this.parser,e,this.name)===null?null:La}extendMaterialParams(e,t){let n=Nu(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.transmissionFactor!==void 0&&(t.transmission=n.transmissionFactor),n.transmissionTexture!==void 0&&r.push(this.parser.assignTexture(t,`transmissionMap`,n.transmissionTexture)),Promise.all(r)}},Hu=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_VOLUME}getMaterialType(e){return Nu(this.parser,e,this.name)===null?null:La}extendMaterialParams(e,t){let n=Nu(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.thickness=n.thicknessFactor===void 0?0:n.thicknessFactor,n.thicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`thicknessMap`,n.thicknessTexture)),t.attenuationDistance=n.attenuationDistance||1/0;let i=n.attenuationColor||[1,1,1];return t.attenuationColor=new Y().setRGB(i[0],i[1],i[2],tt),Promise.all(r)}},Uu=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_IOR}getMaterialType(e){return Nu(this.parser,e,this.name)===null?null:La}extendMaterialParams(e,t){let n=Nu(this.parser,e,this.name);return n===null?Promise.resolve():(t.ior=n.ior===void 0?1.5:n.ior,t.ior===0&&(t.ior=1e3),Promise.resolve())}},Wu=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_SPECULAR}getMaterialType(e){return Nu(this.parser,e,this.name)===null?null:La}extendMaterialParams(e,t){let n=Nu(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.specularIntensity=n.specularFactor===void 0?1:n.specularFactor,n.specularTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularIntensityMap`,n.specularTexture));let i=n.specularColorFactor||[1,1,1];return t.specularColor=new Y().setRGB(i[0],i[1],i[2],tt),n.specularColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularColorMap`,n.specularColorTexture,et)),Promise.all(r)}},Gu=class{constructor(e){this.parser=e,this.name=$.EXT_MATERIALS_BUMP}getMaterialType(e){return Nu(this.parser,e,this.name)===null?null:La}extendMaterialParams(e,t){let n=Nu(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return t.bumpScale=n.bumpFactor===void 0?1:n.bumpFactor,n.bumpTexture!==void 0&&r.push(this.parser.assignTexture(t,`bumpMap`,n.bumpTexture)),Promise.all(r)}},Ku=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return Nu(this.parser,e,this.name)===null?null:La}extendMaterialParams(e,t){let n=Nu(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.anisotropyStrength!==void 0&&(t.anisotropy=n.anisotropyStrength),n.anisotropyRotation!==void 0&&(t.anisotropyRotation=n.anisotropyRotation),n.anisotropyTexture!==void 0&&r.push(this.parser.assignTexture(t,`anisotropyMap`,n.anisotropyTexture)),Promise.all(r)}},qu=class{constructor(e){this.parser=e,this.name=$.KHR_TEXTURE_BASISU}loadTexture(e){let t=this.parser,n=t.json,r=n.textures[e];if(!r.extensions||!r.extensions[this.name])return null;let i=r.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures`);return null}return t.loadTextureImage(e,i.source,a)}},Ju=class{constructor(e){this.parser=e,this.name=$.EXT_TEXTURE_WEBP}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},Yu=class{constructor(e){this.parser=e,this.name=$.EXT_TEXTURE_AVIF}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},Xu=class{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){let t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){let e=n.extensions[this.name],r=this.parser.getDependency(`buffer`,e.buffer),i=this.parser.options.meshoptDecoder;if(!i||!i.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files`);return null}return r.then(function(t){let n=e.byteOffset||0,r=e.byteLength||0,a=e.count,o=e.byteStride,s=new Uint8Array(t,n,r);return i.decodeGltfBufferAsync?i.decodeGltfBufferAsync(a,o,s,e.mode,e.filter).then(function(e){return e.buffer}):i.ready.then(function(){let t=new ArrayBuffer(a*o);return i.decodeGltfBuffer(new Uint8Array(t),a,o,s,e.mode,e.filter),t})})}else return null}},Zu=class{constructor(e){this.name=$.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){let t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;let r=t.meshes[n.mesh];for(let e of r.primitives)if(e.mode!==cd.TRIANGLES&&e.mode!==cd.TRIANGLE_STRIP&&e.mode!==cd.TRIANGLE_FAN&&e.mode!==void 0)return null;let i=n.extensions[this.name].attributes,a=[],o={};for(let e in i)a.push(this.parser.getDependency(`accessor`,i[e]).then(t=>(o[e]=t,o[e])));return a.length<1?null:(a.push(this.parser.createNodeMesh(e)),Promise.all(a).then(e=>{let t=e.pop(),n=t.isGroup?t.children:[t],r=e[0].count,i=[];for(let e of n){let t=new J,n=new W,a=new Gt,s=new W(1,1,1),c=new Bi(e.geometry,e.material,r);for(let e=0;e<r;e++)o.TRANSLATION&&n.fromBufferAttribute(o.TRANSLATION,e),o.ROTATION&&a.fromBufferAttribute(o.ROTATION,e),o.SCALE&&s.fromBufferAttribute(o.SCALE,e),c.setMatrixAt(e,t.compose(n,a,s));for(let t in o)if(t===`_COLOR_0`){let e=o[t];c.instanceColor=new Mi(e.array,e.itemSize,e.normalized)}else t!==`TRANSLATION`&&t!==`ROTATION`&&t!==`SCALE`&&e.geometry.setAttribute(t,o[t]);zn.prototype.copy.call(c,e),this.parser.assignFinalMaterial(c),i.push(c)}return t.isGroup?(t.clear(),t.add(...i),t):i[0]}))}},Qu=`glTF`,$u=12,ed={JSON:1313821514,BIN:5130562},td=class{constructor(e){this.name=$.KHR_BINARY_GLTF,this.content=null,this.body=null;let t=new DataView(e,0,$u),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==Qu)throw Error(`THREE.GLTFLoader: Unsupported glTF-Binary header.`);if(this.header.version<2)throw Error(`THREE.GLTFLoader: Legacy binary file detected.`);let r=this.header.length-$u,i=new DataView(e,$u),a=0;for(;a<r;){let t=i.getUint32(a,!0);a+=4;let r=i.getUint32(a,!0);if(a+=4,r===ed.JSON){let r=new Uint8Array(e,$u+a,t);this.content=n.decode(r)}else if(r===ed.BIN){let n=$u+a;this.body=e.slice(n,n+t)}a+=t}if(this.content===null)throw Error(`THREE.GLTFLoader: JSON content not found.`)}},nd=class{constructor(e,t){if(!t)throw Error(`THREE.GLTFLoader: No DRACOLoader instance provided.`);this.name=$.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){let n=this.json,r=this.dracoLoader,i=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},s={},c={};for(let e in a){let t=pd[e]||e.toLowerCase();o[t]=a[e]}for(let t in e.attributes){let r=pd[t]||t.toLowerCase();if(a[t]!==void 0){let i=n.accessors[e.attributes[t]];c[r]=ld[i.componentType].name,s[r]=i.normalized===!0}}return t.getDependency(`bufferView`,i).then(function(e){return new Promise(function(t,n){r.decodeDracoFile(e,function(e){for(let t in e.attributes){let n=e.attributes[t],r=s[t];r!==void 0&&(n.normalized=r)}t(e)},o,c,tt,n)})})}},rd=class{constructor(){this.name=$.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0?e:(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0,e)}},id=class{constructor(){this.name=$.KHR_MESH_QUANTIZATION}},ad=class extends Wa{constructor(e,t,n,r){super(e,t,n,r)}copySampleValue_(e){let t=this.resultBuffer,n=this.sampleValues,r=this.valueSize,i=e*r*3+r;for(let e=0;e!==r;e++)t[e]=n[i+e];return t}interpolate_(e,t,n,r){let i=this.resultBuffer,a=this.sampleValues,o=this.valueSize,s=o*2,c=o*3,l=r-t,u=(n-t)/l,d=u*u,f=d*u,p=e*c,m=p-c,h=-2*f+3*d,g=f-d,_=1-h,v=g-d+u;for(let e=0;e!==o;e++){let t=a[m+e+o],n=a[m+e+s]*l,r=a[p+e+o],c=a[p+e]*l;i[e]=_*t+v*n+h*r+g*c}return i}},od=new Gt,sd=class extends ad{interpolate_(e,t,n,r){let i=super.interpolate_(e,t,n,r);return od.fromArray(i).normalize().toArray(i),i}},cd={FLOAT:5126,FLOAT_MAT3:35675,FLOAT_MAT4:35676,FLOAT_VEC2:35664,FLOAT_VEC3:35665,FLOAT_VEC4:35666,LINEAR:9729,REPEAT:10497,SAMPLER_2D:35678,POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6,UNSIGNED_BYTE:5121,UNSIGNED_SHORT:5123},ld={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},ud={9728:h,9729:v,9984:g,9985:y,9986:_,9987:b},dd={33071:p,33648:m,10497:f},fd={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},pd={POSITION:`position`,NORMAL:`normal`,TANGENT:`tangent`,TEXCOORD_0:`uv`,TEXCOORD_1:`uv1`,TEXCOORD_2:`uv2`,TEXCOORD_3:`uv3`,COLOR_0:`color`,WEIGHTS_0:`skinWeight`,JOINTS_0:`skinIndex`},md={scale:`scale`,translation:`position`,rotation:`quaternion`,weights:`morphTargetInfluences`},hd={CUBICSPLINE:void 0,LINEAR:Ge,STEP:We},gd={OPAQUE:`OPAQUE`,MASK:`MASK`,BLEND:`BLEND`};function _d(e){return e.DefaultMaterial===void 0&&(e.DefaultMaterial=new Ia({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:0})),e.DefaultMaterial}function vd(e,t,n){for(let r in n.extensions)e[r]===void 0&&(t.userData.gltfExtensions=t.userData.gltfExtensions||{},t.userData.gltfExtensions[r]=n.extensions[r])}function yd(e,t){t.extras!==void 0&&(typeof t.extras==`object`?Object.assign(e.userData,t.extras):console.warn(`THREE.GLTFLoader: Ignoring primitive type .extras, `+t.extras))}function bd(e,t,n){let r=!1,i=!1,a=!1;for(let e=0,n=t.length;e<n;e++){let n=t[e];if(n.POSITION!==void 0&&(r=!0),n.NORMAL!==void 0&&(i=!0),n.COLOR_0!==void 0&&(a=!0),r&&i&&a)break}if(!r&&!i&&!a)return Promise.resolve(e);let o=[],s=[],c=[];for(let l=0,u=t.length;l<u;l++){let u=t[l];if(r){let t=u.POSITION===void 0?e.attributes.position:n.getDependency(`accessor`,u.POSITION);o.push(t)}if(i){let t=u.NORMAL===void 0?e.attributes.normal:n.getDependency(`accessor`,u.NORMAL);s.push(t)}if(a){let t=u.COLOR_0===void 0?e.attributes.color:n.getDependency(`accessor`,u.COLOR_0);c.push(t)}}return Promise.all([Promise.all(o),Promise.all(s),Promise.all(c)]).then(function(t){let n=t[0],o=t[1],s=t[2];return r&&(e.morphAttributes.position=n),i&&(e.morphAttributes.normal=o),a&&(e.morphAttributes.color=s),e.morphTargetsRelative=!0,e})}function xd(e,t){if(e.updateMorphTargets(),t.weights!==void 0)for(let n=0,r=t.weights.length;n<r;n++)e.morphTargetInfluences[n]=t.weights[n];if(t.extras&&Array.isArray(t.extras.targetNames)){let n=t.extras.targetNames;if(e.morphTargetInfluences.length===n.length){e.morphTargetDictionary={};for(let t=0,r=n.length;t<r;t++)e.morphTargetDictionary[n[t]]=t}else console.warn(`THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.`)}}function Sd(e){let t,n=e.extensions&&e.extensions[$.KHR_DRACO_MESH_COMPRESSION];if(t=n?`draco:`+n.bufferView+`:`+n.indices+`:`+Cd(n.attributes):e.indices+`:`+Cd(e.attributes)+`:`+e.mode,e.targets!==void 0)for(let n=0,r=e.targets.length;n<r;n++)t+=`:`+Cd(e.targets[n]);return t}function Cd(e){let t=``,n=Object.keys(e).sort();for(let r=0,i=n.length;r<i;r++)t+=n[r]+`:`+e[n[r]]+`;`;return t}function wd(e){switch(e){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw Error(`THREE.GLTFLoader: Unsupported normalized accessor component type.`)}}function Td(e){return e.search(/\.jpe?g($|\?)/i)>0||e.search(/^data\:image\/jpeg/)===0?`image/jpeg`:e.search(/\.webp($|\?)/i)>0||e.search(/^data\:image\/webp/)===0?`image/webp`:e.search(/\.ktx2($|\?)/i)>0||e.search(/^data\:image\/ktx2/)===0?`image/ktx2`:`image/png`}var Ed=new J,Dd=class{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new Mu,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,r=-1,i=!1,a=-1;if(typeof navigator<`u`&&navigator.userAgent!==void 0){let e=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(e)===!0;let t=e.match(/Version\/(\d+)/);r=n&&t?parseInt(t[1],10):-1,i=e.indexOf(`Firefox`)>-1,a=i?e.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>`u`||n&&r<17||i&&a<98?this.textureLoader=new go(this.options.manager):this.textureLoader=new Bo(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new po(this.options.manager),this.fileLoader.setResponseType(`arraybuffer`),this.options.crossOrigin===`use-credentials`&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){let n=this,r=this.json,i=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(e){return e._markDefs&&e._markDefs()}),Promise.all(this._invokeAll(function(e){return e.beforeRoot&&e.beforeRoot()})).then(function(){return Promise.all([n.getDependencies(`scene`),n.getDependencies(`animation`),n.getDependencies(`camera`)])}).then(function(t){let a={scene:t[0][r.scene||0],scenes:t[0],animations:t[1],cameras:t[2],asset:r.asset,parser:n,userData:{}};return vd(i,a,r),yd(a,r),Promise.all(n._invokeAll(function(e){return e.afterRoot&&e.afterRoot(a)})).then(function(){for(let e of a.scenes)e.updateMatrixWorld();e(a)})}).catch(t)}_markDefs(){let e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n].joints;for(let t=0,n=r.length;t<n;t++)e[r[t]].isBone=!0}for(let t=0,r=e.length;t<r;t++){let r=e[t];r.mesh!==void 0&&(this._addNodeRef(this.meshCache,r.mesh),r.skin!==void 0&&(n[r.mesh].isSkinnedMesh=!0)),r.camera!==void 0&&this._addNodeRef(this.cameraCache,r.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;let r=n.clone(),i=(e,t)=>{let n=this.associations.get(e);n!=null&&this.associations.set(t,n);for(let[n,r]of e.children.entries())i(r,t.children[n])};return i(n,r),r.name+=`_instance_`+ e.uses[t]++,r}_invokeOne(e){let t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){let r=e(t[n]);if(r)return r}return null}_invokeAll(e){let t=Object.values(this.plugins);t.unshift(this);let n=[];for(let r=0;r<t.length;r++){let i=e(t[r]);i&&n.push(i)}return n}getDependency(e,t){let n=e+`:`+t,r=this.cache.get(n);if(!r){switch(e){case`scene`:r=this.loadScene(t);break;case`node`:r=this._invokeOne(function(e){return e.loadNode&&e.loadNode(t)});break;case`mesh`:r=this._invokeOne(function(e){return e.loadMesh&&e.loadMesh(t)});break;case`accessor`:r=this.loadAccessor(t);break;case`bufferView`:r=this._invokeOne(function(e){return e.loadBufferView&&e.loadBufferView(t)});break;case`buffer`:r=this.loadBuffer(t);break;case`material`:r=this._invokeOne(function(e){return e.loadMaterial&&e.loadMaterial(t)});break;case`texture`:r=this._invokeOne(function(e){return e.loadTexture&&e.loadTexture(t)});break;case`skin`:r=this.loadSkin(t);break;case`animation`:r=this._invokeOne(function(e){return e.loadAnimation&&e.loadAnimation(t)});break;case`camera`:r=this.loadCamera(t);break;default:if(r=this._invokeOne(function(n){return n!=this&&n.getDependency&&n.getDependency(e,t)}),!r)throw Error(`Unknown type: `+e);break}this.cache.add(n,r)}return r}getDependencies(e){let t=this.cache.get(e);if(!t){let n=this,r=this.json[e+(e===`mesh`?`es`:`s`)]||[];t=Promise.all(r.map(function(t,r){return n.getDependency(e,r)})),this.cache.add(e,t)}return t}loadBuffer(e){let t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!==`arraybuffer`)throw Error(`THREE.GLTFLoader: `+t.type+` buffer type is not supported.`);if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[$.KHR_BINARY_GLTF].body);let r=this.options;return new Promise(function(e,i){n.load(Ro.resolveURL(t.uri,r.path),e,void 0,function(){i(Error(`THREE.GLTFLoader: Failed to load buffer "`+t.uri+`".`))})})}loadBufferView(e){let t=this.json.bufferViews[e];return this.getDependency(`buffer`,t.buffer).then(function(e){let n=t.byteLength||0,r=t.byteOffset||0;return e.slice(r,r+n)})}loadAccessor(e){let t=this,n=this.json,r=this.json.accessors[e];if(r.bufferView===void 0&&r.sparse===void 0){let e=fd[r.type],t=ld[r.componentType],n=r.normalized===!0,i=new t(r.count*e);return Promise.resolve(new Dr(i,e,n))}let i=[];return r.bufferView===void 0?i.push(null):i.push(this.getDependency(`bufferView`,r.bufferView)),r.sparse!==void 0&&(i.push(this.getDependency(`bufferView`,r.sparse.indices.bufferView)),i.push(this.getDependency(`bufferView`,r.sparse.values.bufferView))),Promise.all(i).then(function(e){let i=e[0],a=fd[r.type],o=ld[r.componentType],s=o.BYTES_PER_ELEMENT,c=s*a,l=r.byteOffset||0,u=r.bufferView===void 0?void 0:n.bufferViews[r.bufferView].byteStride,d=r.normalized===!0,f,p;if(u&&u!==c){let e=Math.floor(l/u),n=`InterleavedBuffer:`+r.bufferView+`:`+r.componentType+`:`+e+`:`+r.count,c=t.cache.get(n);c||(f=new o(i,e*u,r.count*u/s),c=new Ur(f,u/s),t.cache.add(n,c)),p=new Gr(c,a,l%u/s,d)}else f=i===null?new o(r.count*a):new o(i,l,r.count*a),p=new Dr(f,a,d);if(r.sparse!==void 0){let t=fd.SCALAR,n=ld[r.sparse.indices.componentType],s=r.sparse.indices.byteOffset||0,c=r.sparse.values.byteOffset||0,l=new n(e[1],s,r.sparse.count*t),u=new o(e[2],c,r.sparse.count*a);i!==null&&(p=new Dr(p.array.slice(),p.itemSize,p.normalized)),p.normalized=!1;for(let e=0,t=l.length;e<t;e++){let t=l[e];if(p.setX(t,u[e*a]),a>=2&&p.setY(t,u[e*a+1]),a>=3&&p.setZ(t,u[e*a+2]),a>=4&&p.setW(t,u[e*a+3]),a>=5)throw Error(`THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.`)}p.normalized=d}return p})}loadTexture(e){let t=this.json,n=this.options,r=t.textures[e].source,i=t.images[r],a=this.textureLoader;if(i.uri){let e=n.manager.getHandler(i.uri);e!==null&&(a=e)}return this.loadTextureImage(e,r,a)}loadTextureImage(e,t,n){let r=this,i=this.json,a=i.textures[e],o=i.images[t],s=(o.uri||o.bufferView)+`:`+a.sampler;if(this.textureCache[s])return this.textureCache[s];let c=this.loadImageSource(t,n).then(function(t){t.flipY=!1,t.name=a.name||o.name||``,t.name===``&&typeof o.uri==`string`&&o.uri.startsWith(`data:image/`)===!1&&(t.name=o.uri);let n=(i.samplers||{})[a.sampler]||{};return t.magFilter=ud[n.magFilter]||1006,t.minFilter=ud[n.minFilter]||1008,t.wrapS=dd[n.wrapS]||1e3,t.wrapT=dd[n.wrapT]||1e3,t.generateMipmaps=!t.isCompressedTexture&&t.minFilter!==1003&&t.minFilter!==1006,r.associations.set(t,{textures:e}),t}).catch(function(){return null});return this.textureCache[s]=c,c}loadImageSource(e,t){let n=this,r=this.json,i=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(e=>e.clone());let a=r.images[e],o=self.URL||self.webkitURL,s=a.uri||``,c=!1;if(a.bufferView!==void 0)s=n.getDependency(`bufferView`,a.bufferView).then(function(e){c=!0;let t=new Blob([e],{type:a.mimeType});return s=o.createObjectURL(t),s});else if(a.uri===void 0)throw Error(`THREE.GLTFLoader: Image `+e+` is missing URI and bufferView`);let l=Promise.resolve(s).then(function(e){return new Promise(function(n,r){let a=n;t.isImageBitmapLoader===!0&&(a=function(e){let t=new cn(e);t.needsUpdate=!0,n(t)}),t.load(Ro.resolveURL(e,i.path),a,void 0,r)})}).then(function(e){return c===!0&&o.revokeObjectURL(s),yd(e,a),e.userData.mimeType=a.mimeType||Td(a.uri),e}).catch(function(e){throw console.error(`THREE.GLTFLoader: Couldn't load texture`,s),e});return this.sourceCache[e]=l,l}assignTexture(e,t,n,r){let i=this;return this.getDependency(`texture`,n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),i.extensions[$.KHR_TEXTURE_TRANSFORM]){let e=n.extensions===void 0?void 0:n.extensions[$.KHR_TEXTURE_TRANSFORM];if(e){let t=i.associations.get(a);a=i.extensions[$.KHR_TEXTURE_TRANSFORM].extendTexture(a,e),i.associations.set(a,t)}}return r!==void 0&&(a.colorSpace=r),e[t]=a,a})}assignFinalMaterial(e){let t=e.geometry,n=e.material,r=t.attributes.tangent===void 0,i=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){let e=`PointsMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new la,qr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,t.sizeAttenuation=!1,this.cache.add(e,t)),n=t}else if(e.isLine){let e=`LineBasicMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new Yi,qr.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,this.cache.add(e,t)),n=t}if(r||i||a){let e=`ClonedMaterial:`+n.uuid+`:`;r&&(e+=`derivative-tangents:`),i&&(e+=`vertex-colors:`),a&&(e+=`flat-shading:`);let t=this.cache.get(e);t||(t=n.clone(),i&&(t.vertexColors=!0),a&&(t.flatShading=!0),r&&(t.normalScale&&(t.normalScale.y*=-1),t.clearcoatNormalScale&&(t.clearcoatNormalScale.y*=-1)),this.cache.add(e,t),this.associations.set(t,this.associations.get(n))),n=t}e.material=n}getMaterialType(){return Ia}loadMaterial(e){let t=this,n=this.json,r=this.extensions,i=n.materials[e],a,o={},s=i.extensions||{},c=[];if(s[$.KHR_MATERIALS_UNLIT]){let e=r[$.KHR_MATERIALS_UNLIT];a=e.getMaterialType(),c.push(e.extendParams(o,i,t))}else{let n=i.pbrMetallicRoughness||{};if(o.color=new Y(1,1,1),o.opacity=1,Array.isArray(n.baseColorFactor)){let e=n.baseColorFactor;o.color.setRGB(e[0],e[1],e[2],tt),o.opacity=e[3]}n.baseColorTexture!==void 0&&c.push(t.assignTexture(o,`map`,n.baseColorTexture,et)),o.metalness=n.metallicFactor===void 0?1:n.metallicFactor,o.roughness=n.roughnessFactor===void 0?1:n.roughnessFactor,n.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,`metalnessMap`,n.metallicRoughnessTexture)),c.push(t.assignTexture(o,`roughnessMap`,n.metallicRoughnessTexture))),a=this._invokeOne(function(t){return t.getMaterialType&&t.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(t){return t.extendMaterialParams&&t.extendMaterialParams(e,o)})))}i.doubleSided===!0&&(o.side=2);let l=i.alphaMode||gd.OPAQUE;if(l===gd.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,l===gd.MASK&&(o.alphaTest=i.alphaCutoff===void 0?.5:i.alphaCutoff)),i.normalTexture!==void 0&&a!==ni&&(c.push(t.assignTexture(o,`normalMap`,i.normalTexture)),o.normalScale=new U(1,1),i.normalTexture.scale!==void 0)){let e=i.normalTexture.scale;o.normalScale.set(e,e)}if(i.occlusionTexture!==void 0&&a!==ni&&(c.push(t.assignTexture(o,`aoMap`,i.occlusionTexture)),i.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=i.occlusionTexture.strength)),i.emissiveFactor!==void 0&&a!==ni){let e=i.emissiveFactor;o.emissive=new Y().setRGB(e[0],e[1],e[2],tt)}return i.emissiveTexture!==void 0&&a!==ni&&c.push(t.assignTexture(o,`emissiveMap`,i.emissiveTexture,et)),Promise.all(c).then(function(){let n=new a(o);return i.name&&(n.name=i.name),yd(n,i),t.associations.set(n,{materials:e}),i.extensions&&vd(r,n,i),n})}createUniqueName(e){let t=X.sanitizeNodeName(e||``);return t in this.nodeNamesUsed?t+`_`+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){let t=this,n=this.extensions,r=this.primitiveCache;function i(e){return n[$.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(e,t).then(function(n){return kd(n,e,t)})}let a=[];for(let n=0,o=e.length;n<o;n++){let o=e[n],s=Sd(o),c=r[s];if(c)a.push(c.promise);else{let e;e=o.extensions&&o.extensions[$.KHR_DRACO_MESH_COMPRESSION]?i(o):kd(new Hr,o,t),r[s]={primitive:o,promise:e},a.push(e)}}return Promise.all(a)}loadMesh(e){let t=this,n=this.json,r=this.extensions,i=n.meshes[e],a=i.primitives,o=[];for(let e=0,t=a.length;e<t;e++){let t=a[e].material===void 0?_d(this.cache):this.getDependency(`material`,a[e].material);o.push(t)}return o.push(t.loadGeometries(a)),Promise.all(o).then(function(n){let o=n.slice(0,n.length-1),s=n[n.length-1],c=[];for(let n=0,l=s.length;n<l;n++){let l=s[n],u=a[n],d,f=o[n];if(u.mode===cd.TRIANGLES||u.mode===cd.TRIANGLE_STRIP||u.mode===cd.TRIANGLE_FAN||u.mode===void 0)d=i.isSkinnedMesh===!0?new Ei(l,f):new mi(l,f),d.isSkinnedMesh===!0&&d.normalizeSkinWeights(),u.mode===cd.TRIANGLE_STRIP?d.geometry=Ou(d.geometry,1):u.mode===cd.TRIANGLE_FAN&&(d.geometry=Ou(d.geometry,2));else if(u.mode===cd.LINES)d=new sa(l,f);else if(u.mode===cd.LINE_STRIP)d=new ra(l,f);else if(u.mode===cd.LINE_LOOP)d=new ca(l,f);else if(u.mode===cd.POINTS)d=new ma(l,f);else throw Error(`THREE.GLTFLoader: Primitive mode unsupported: `+u.mode);Object.keys(d.geometry.morphAttributes).length>0&&xd(d,i),d.name=t.createUniqueName(i.name||`mesh_`+e),yd(d,i),u.extensions&&vd(r,d,u),t.assignFinalMaterial(d),c.push(d)}for(let n=0,r=c.length;n<r;n++)t.associations.set(c[n],{meshes:e,primitives:n});if(c.length===1)return i.extensions&&vd(r,c[0],i),c[0];let l=new Bn;i.extensions&&vd(r,l,i),t.associations.set(l,{meshes:e});for(let e=0,t=c.length;e<t;e++)l.add(c[e]);return l})}loadCamera(e){let t,n=this.json.cameras[e],r=n[n.type];if(!r){console.warn(`THREE.GLTFLoader: Missing camera parameters.`);return}return n.type===`perspective`?t=new Ao(Wt.radToDeg(r.yfov),r.aspectRatio||1,r.znear||1,r.zfar||2e6):n.type===`orthographic`&&(t=new Fo(-r.xmag,r.xmag,r.ymag,-r.ymag,r.znear,r.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),yd(t,n),Promise.resolve(t)}loadSkin(e){let t=this.json.skins[e],n=[];for(let e=0,r=t.joints.length;e<r;e++)n.push(this._loadNodeShallow(t.joints[e]));return t.inverseBindMatrices===void 0?n.push(null):n.push(this.getDependency(`accessor`,t.inverseBindMatrices)),Promise.all(n).then(function(e){let n=e.pop(),r=e,i=[],a=[];for(let e=0,o=r.length;e<o;e++){let o=r[e];if(o){i.push(o);let t=new J;n!==null&&t.fromArray(n.array,e*16),a.push(t)}else console.warn(`THREE.GLTFLoader: Joint "%s" could not be found.`,t.joints[e])}return new ji(i,a)})}loadAnimation(e){let t=this.json,n=this,r=t.animations[e],i=r.name?r.name:`animation_`+e,a=[],o=[],s=[],c=[],l=[];for(let e=0,t=r.channels.length;e<t;e++){let t=r.channels[e],n=r.samplers[t.sampler],i=t.target,u=i.node,d=r.parameters===void 0?n.input:r.parameters[n.input],f=r.parameters===void 0?n.output:r.parameters[n.output];i.node!==void 0&&(a.push(this.getDependency(`node`,u)),o.push(this.getDependency(`accessor`,d)),s.push(this.getDependency(`accessor`,f)),c.push(n),l.push(i))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(s),Promise.all(c),Promise.all(l)]).then(function(e){let t=e[0],a=e[1],o=e[2],s=e[3],c=e[4],l=[];for(let e=0,r=t.length;e<r;e++){let r=t[e],i=a[e],u=o[e],d=s[e],f=c[e];if(r===void 0)continue;r.updateMatrix&&r.updateMatrix();let p=n._createAnimationTracks(r,i,u,d,f);if(p)for(let e=0;e<p.length;e++)l.push(p[e])}let u=new ro(i,void 0,l);return yd(u,r),u})}createNodeMesh(e){let t=this.json,n=this,r=t.nodes[e];return r.mesh===void 0?null:n.getDependency(`mesh`,r.mesh).then(function(e){let t=n._getNodeRef(n.meshCache,r.mesh,e);return r.weights!==void 0&&t.traverse(function(e){if(e.isMesh)for(let t=0,n=r.weights.length;t<n;t++)e.morphTargetInfluences[t]=r.weights[t]}),t})}loadNode(e){let t=this.json,n=this,r=t.nodes[e],i=n._loadNodeShallow(e),a=[],o=r.children||[];for(let e=0,t=o.length;e<t;e++)a.push(n.getDependency(`node`,o[e]));let s=r.skin===void 0?Promise.resolve(null):n.getDependency(`skin`,r.skin);return Promise.all([i,Promise.all(a),s]).then(function(e){let t=e[0],n=e[1],r=e[2];r!==null&&t.traverse(function(e){e.isSkinnedMesh&&e.bind(r,Ed)});for(let e=0,r=n.length;e<r;e++)t.add(n[e]);if(t.userData.pivot!==void 0&&n.length>0){let e=t.userData.pivot,r=n[0];t.pivot=new W().fromArray(e),t.position.x-=e[0],t.position.y-=e[1],t.position.z-=e[2],r.position.set(0,0,0),delete t.userData.pivot}return t})}_loadNodeShallow(e){let t=this.json,n=this.extensions,r=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];let i=t.nodes[e],a=i.name?r.createUniqueName(i.name):``,o=[],s=r._invokeOne(function(t){return t.createNodeMesh&&t.createNodeMesh(e)});return s&&o.push(s),i.camera!==void 0&&o.push(r.getDependency(`camera`,i.camera).then(function(e){return r._getNodeRef(r.cameraCache,i.camera,e)})),r._invokeAll(function(t){return t.createNodeAttachment&&t.createNodeAttachment(e)}).forEach(function(e){o.push(e)}),this.nodeCache[e]=Promise.all(o).then(function(t){let o;if(o=i.isBone===!0?new Di:t.length>1?new Bn:t.length===1?t[0]:new zn,o!==t[0])for(let e=0,n=t.length;e<n;e++)o.add(t[e]);if(i.name&&(o.userData.name=i.name,o.name=a),yd(o,i),i.extensions&&vd(n,o,i),i.matrix!==void 0){let e=new J;e.fromArray(i.matrix),o.applyMatrix4(e)}else i.translation!==void 0&&o.position.fromArray(i.translation),i.rotation!==void 0&&o.quaternion.fromArray(i.rotation),i.scale!==void 0&&o.scale.fromArray(i.scale);if(!r.associations.has(o))r.associations.set(o,{});else if(i.mesh!==void 0&&r.meshCache.refs[i.mesh]>1){let e=r.associations.get(o);r.associations.set(o,{...e})}return r.associations.get(o).nodes=e,o}),this.nodeCache[e]}loadScene(e){let t=this.extensions,n=this.json.scenes[e],r=this,i=new Bn;n.name&&(i.name=r.createUniqueName(n.name)),yd(i,n),n.extensions&&vd(t,i,n);let a=n.nodes||[],o=[];for(let e=0,t=a.length;e<t;e++)o.push(r.getDependency(`node`,a[e]));return Promise.all(o).then(function(e){for(let t=0,n=e.length;t<n;t++){let n=e[t];n.parent===null?i.add(n):i.add(ku(n))}return r.associations=(e=>{let t=new Map;for(let[e,n]of r.associations)(e instanceof qr||e instanceof cn)&&t.set(e,n);return e.traverse(e=>{let n=r.associations.get(e);n!=null&&t.set(e,n)}),t})(i),i})}_createAnimationTracks(e,t,n,r,i){let a=[],o=e.name?e.name:e.uuid,s=[];function c(e){e.morphTargetInfluences&&s.push(e.name?e.name:e.uuid)}md[i.path]===md.weights?(c(e),e.isGroup&&e.children.forEach(c)):s.push(o);let l;switch(md[i.path]){case md.weights:l=Qa;break;case md.rotation:l=eo;break;case md.translation:case md.scale:l=no;break;default:switch(n.itemSize){case 1:l=Qa;break;default:l=no;break}break}let u=r.interpolation===void 0?Ge:hd[r.interpolation],d=this._getArrayFromAccessor(n);for(let e=0,n=s.length;e<n;e++){let n=new l(s[e]+`.`+md[i.path],t.array,d,u);r.interpolation===`CUBICSPLINE`&&this._createCubicSplineTrackInterpolant(n),a.push(n)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){let e=wd(t.constructor),n=new Float32Array(t.length);for(let r=0,i=t.length;r<i;r++)n[r]=t[r]*e;t=n}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(e){return new(this instanceof eo?sd:ad)(this.times,this.values,this.getValueSize()/3,e)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}};function Od(e,t,n){let r=t.attributes,i=new lr;if(r.POSITION!==void 0){let e=n.json.accessors[r.POSITION],t=e.min,a=e.max;if(t!==void 0&&a!==void 0){if(i.set(new W(t[0],t[1],t[2]),new W(a[0],a[1],a[2])),e.normalized){let t=wd(ld[e.componentType]);i.min.multiplyScalar(t),i.max.multiplyScalar(t)}}else{console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`);return}}else return;let a=t.targets;if(a!==void 0){let e=new W,t=new W;for(let r=0,i=a.length;r<i;r++){let i=a[r];if(i.POSITION!==void 0){let r=n.json.accessors[i.POSITION],a=r.min,o=r.max;if(a!==void 0&&o!==void 0){if(t.setX(Math.max(Math.abs(a[0]),Math.abs(o[0]))),t.setY(Math.max(Math.abs(a[1]),Math.abs(o[1]))),t.setZ(Math.max(Math.abs(a[2]),Math.abs(o[2]))),r.normalized){let e=wd(ld[r.componentType]);t.multiplyScalar(e)}e.max(t)}else console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`)}}i.expandByVector(e)}e.boundingBox=i;let o=new Pr;i.getCenter(o.center),o.radius=i.min.distanceTo(i.max)/2,e.boundingSphere=o}function kd(e,t,n){let r=t.attributes,i=[];function a(t,r){return n.getDependency(`accessor`,t).then(function(t){e.setAttribute(r,t)})}for(let t in r){let n=pd[t]||t.toLowerCase();n in e.attributes||i.push(a(r[t],n))}if(t.indices!==void 0&&!e.index){let r=n.getDependency(`accessor`,t.indices).then(function(t){e.setIndex(t)});i.push(r)}return K.workingColorSpace!==`srgb-linear`&&`COLOR_0`in r&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${K.workingColorSpace}" not supported.`),yd(e,t),Od(e,t,n),Promise.all(i).then(function(){return t.targets===void 0?e:bd(e,t.targets,n)})}var Ad=class{constructor(e){this.shared=e,this.scene=new Jn,this.camera=new Fo(-1,1,1,-1,.1,2e3),this.ready=!1,this.disposed=!1,this.slots=[],this.bodyCenter=new W,this.centerOffset=new W,this.turnOffset=new W,this.petalSample={x:0,y:0,radius:0,angle:0,alpha:0,kind:0,color:0},this.moteKind=new Mi(new Float32Array(96),1),this.pinkMote=new Y(16755397),this.yellowMote=new Y(16768908),this.motePose=new zn,this.moteAlpha=new Mi(new Float32Array(96),1),this.modelRadius=1,this.ordered=[],this.ranks=new Int16Array(12),this.renderSize=new U,this.assetTextures=new Set,this.renderer=e??new Cu({alpha:!0,antialias:!0}),this.renderer.setPixelRatio(Math.min(devicePixelRatio,1.5)),this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1;let t=new Jn;t.background=new Y(.48,.39,.42);let n=new mi(new Sa(1,64),new ni({color:new Y(4,4,4),side:2}));n.position.set(-3,4,5),n.scale.set(2,3,1),n.lookAt(0,0,0),t.add(n);let r=new As(this.renderer);this.environment=r.fromScene(t,.04),this.scene.environment=this.environment.texture,this.scene.environmentIntensity=.8,n.geometry.dispose(),n.material.dispose(),r.dispose(),this.camera.position.z=1e3,this.scene.add(new vo(16773877,13387644,1));let i=new Lo(16774642,2);i.position.copy(n.position),this.scene.add(i);let a=new Ta(2,2);a.setAttribute(`moteAlpha`,this.moteAlpha),a.setAttribute(`moteKind`,this.moteKind);let o=new Pa({transparent:!0,depthWrite:!1,vertexShader:`attribute float moteAlpha; attribute float moteKind; varying float kind; varying float opacity; varying vec2 pointUv; varying vec3 tint;
        void main(){kind=moteKind;opacity=moteAlpha;pointUv=uv;tint=instanceColor;gl_Position=projectionMatrix*modelViewMatrix*instanceMatrix*vec4(position,1.);}`,fragmentShader:`varying float kind; varying float opacity; varying vec2 pointUv; varying vec3 tint;
...
#include <colorspace_fragment>
 }`});this.motes=new Bi(a,o,96),this.motes.instanceMatrix.setUsage(ot),this.moteAlpha.setUsage(ot);let s=new Y(16758477);for(let e=0;e<96;e++)this.motes.setColorAt(e,s);this.motes.count=0,this.motes.frustumCulled=!1,this.motes.renderOrder=2,this.scene.add(this.motes)}async load(){let e=new Set,t=new Set,n=new Set,r=r=>r.traverse(r=>{if(r instanceof mi){e.add(r.geometry);for(let e of Array.isArray(r.material)?r.material:[r.material]){t.add(e);for(let t of Object.values(e))t instanceof cn&&n.add(t)}}});try{let e=await new ju().loadAsync(`./assets/heart-crystal-v21-pink.glb`);if(r(e.scene),this.disposed)return;let t=e.animations.find(e=>e.name===`Heart_Grow`)||e.animations[0];if(!t)throw Error(`Heart_Grow animation missing`);this.modelRadius=Du(e.scene,t);let n=new as(e.scene);n.clipAction(t).play(),n.setTime(.82),e.scene.updateMatrixWorld(!0);let i=e.scene.getObjectByName(`Heart_Glass`);i&&new lr().setFromObject(i).getCenter(this.bodyCenter),n.stopAllAction(),n.uncacheRoot(e.scene);let a=await new ju().loadAsync(`./assets/heart-crystal-v21-yellow.glb`);if(r(a.scene),this.disposed)return;let o=a.scene.getObjectByName(`Heart_Glass`).material;for(let n=0;n<12;n++){let n=new Bn,r=e.scene.clone(!0),i=[],a=[],s=[];r.traverse(e=>{if(e instanceof mi){let t=e.material.clone();this.restoreEstablishedMaterial(t),e.visible=e.name===`Heart_Glass`,e.material=t,e.renderOrder=1,i.push(t),s.push(e);let n=o.clone();a.push(n),this.restoreEstablishedMaterial(n)}});let c=new Bn,l=new Bn;c.position.copy(this.bodyCenter),r.position.sub(this.bodyCenter),l.add(r),c.add(l),n.add(c),n.visible=!1,this.scene.add(n);let u=new as(r),d=u.clipAction(t);d.setLoop(Ve,1),d.clampWhenFinished=!0,d.play(),this.slots.push({root:n,axis:c,unrotate:l,mixer:u,materials:i,peach:a,meshes:s})}this.ready=!0}finally{let r=new Set;for(let e of this.slots)for(let t of e.meshes)r.add(t.geometry);for(let t of e)r.has(t)||t.dispose();for(let e of t)e.dispose();for(let e of n)this.ready?this.assetTextures.add(e):e.dispose()}}restoreEstablishedMaterial(e){e.transparent=!1,e.depthWrite=!0,e.side=0,e.transmission=0,e.thickness=0,e.userData.baseOpacity=1,e.roughness=.13,e.clearcoat=.65,e.clearcoatRoughness=.13}draw(t,n,i,u,d=e,f){if(!this.ready||n<1||i<1)return;let p=this.renderSize;this.renderer.getSize(p),(p.x!==n||p.y!==i)&&this.renderer.setSize(n,i),c(t,this.ordered,d);let m=0;for(let e=0;e<this.ordered.length;e++){let n=this.ordered[e];this.ranks[n]=e,m=Math.max(m,t[n].size)}let h=o(this.modelRadius*m/2,this.ordered.length);this.camera.position.z=h.cameraZ,(this.camera.right!==n/2||this.camera.top!==i/2||this.camera.far!==h.far)&&(this.camera.far=h.far,this.camera.left=-n/2,this.camera.right=n/2,this.camera.top=i/2,this.camera.bottom=-i/2,this.camera.updateProjectionMatrix());let g=0;for(let e=0;e<12;e++){let o=this.slots[e],c=t[e];if(o.root.visible=!!c?.active&&c.age<d,!o.root.visible)continue;let f=c.angle??0;o.root.position.set(c.x+Math.sin(f)*8-n/2,i/2-c.y+Math.cos(f)*8,this.ranks[e]*h.spacing);let p=a(c.age,d),m=c.size/2;o.root.scale.setScalar(m*p),o.root.rotation.z=-(c.appearanceAngle??c.angle??0),o.root.rotation.y=u??Math.sin(c.age*2)*.12,o.mixer.setTime(r(Math.min(c.age,d-l),d)),this.centerOffset.copy(this.bodyCenter).applyEuler(o.root.rotation).multiplyScalar(m),o.root.position.addScaledVector(this.centerOffset,1-p),o.root.rotation.z-=c.motionAngle??0,this.turnOffset.copy(this.bodyCenter).applyEuler(o.root.rotation).multiplyScalar(m*p),o.root.position.addScaledVector(this.centerOffset,p).sub(this.turnOffset);let g=Math.max(0,Math.min(1,(c.age-(d-.3))/.24)),_=Math.sin(g*Math.PI)*.06;o.root.scale.x*=1-_,o.root.scale.y*=1+_,this.turnOffset.copy(this.bodyCenter).multiply(o.root.scale).applyEuler(o.root.rotation),o.root.position.set(c.x+Math.sin(f)*8-n/2+this.centerOffset.x-this.turnOffset.x,i/2-c.y+Math.cos(f)*8+this.centerOffset.y-this.turnOffset.y,this.ranks[e]*h.spacing);let v=s(c),y=-(c.hitAngle??0)-o.root.rotation.z;o.axis.rotation.z=y,o.unrotate.rotation.z=-y,o.axis.scale.set(1-v,1+v*.65,1+v*.25);let b=c.colorOrder!==void 0&&c.colorOrder%2==1?o.peach:o.materials;o.meshes.forEach((e,t)=>{e.material=b[t]}),b.forEach(e=>{e.transparent&&(e.transparent=!1,e.depthWrite=!0,e.needsUpdate=!0),e.opacity=e.userData.baseOpacity})}if(f){for(let e of f.groups)if(e.active)for(let t=0;t<e.count&&g<72;t++){let r=f.sample(e,t,this.petalSample);r.alpha<=0||(this.motePose.position.set(r.x-n/2,i/2-r.y,0),this.motePose.rotation.z=-r.angle,this.motePose.scale.set(r.radius,r.radius,1),this.motePose.updateMatrix(),this.motes.setMatrixAt(g,this.motePose.matrix),this.motes.setColorAt(g,r.color?this.yellowMote:this.pinkMote),this.moteAlpha.setX(g,r.alpha),this.moteKind.setX(g,r.kind),g++)}}this.motes.count=g,this.motes.instanceMatrix.needsUpdate=!0,this.moteAlpha.needsUpdate=!0,this.moteKind.needsUpdate=!0,this.motes.instanceColor&&(this.motes.instanceColor.needsUpdate=!0),this.renderer.render(this.scene,this.camera)}dispose(){if(this.disposed)return;this.disposed=!0,this.ready=!1,this.motes.geometry.dispose(),this.motes.material.dispose();let e=new Set;for(let t of this.slots)t.mixer.stopAllAction(),t.mixer.uncacheRoot(t.mixer.getRoot()),t.materials.forEach(e=>e.dispose()),t.peach.forEach(e=>e.dispose()),t.root.traverse(t=>{t instanceof mi&&e.add(t.geometry)});e.forEach(e=>e.dispose()),this.assetTextures.forEach(e=>e.dispose()),this.assetTextures.clear(),this.environment.dispose(),this.shared||this.renderer.dispose(),this.slots=[]}},jd=`
#include <common>
#include <morphtarget_pars_vertex>
...
void main(){
 ...
 #include <colorspace_fragment>
}`;function Nd(e){return new Pa({vertexShader:jd,fragmentShader:Md,transparent:!0,depthWrite:!1,side:0,uniforms:{uBackground:{value:e.background},uFilmMatcap:{value:e.film},uHighlightMatcap:{value:e.highlight},uResolution:{value:new U(1,1)},uTime:{value:0},uSeed:{value:0},uRadiusPx:{value:48},uRefraction:{value:.05},uFilmStrength:{value:.78},uHighlightStrength:{value:1.4},uOpening:{value:-1},uBirthAlpha:{value:1},uPopAxis:{value:new W(0,0,1)}}})}function Pd(e,t,n,r,i,a){let o=e.uniforms;o.uResolution.value.set(n*i,r*i),o.uTime.value=t.age,o.uSeed.value=a,o.uRadiusPx.value=t.r*i,o.uBirthAlpha.value=Math.min(1,t.age/.1),o.uOpening.value=t.pop>=0?Math.min(1.1,1.1*(t.pop/.06)**.8):-1}function Fd(){return{drop:new wa(1,0)}}function Id(e,t){let n=new Bn,r=new La({color:14544639,roughness:.08,clearcoat:1,envMap:t,envMapIntensity:1.4,transparent:!0,opacity:1}),i=Array.from({length:5},()=>{let t=new mi(e.drop,r);return n.add(t),t}),a=i.map((e,t)=>{let n=t*2.399+.23,r=1+.035*Math.sin(7*n+.4)+.022*Math.sin(13*n-1),i=.94;return{time:.06*(i/(1.1*r))**(1/.8),position:new W(Math.cos(n)*i,Math.sin(n)*i,Math.sqrt(1-i*i)),velocity:new W(Math.cos(n)*1.4,Math.sin(n)*1.4,.35),size:.009+t*.0015}});return{root:n,update(e){n.visible=e>=0&&e<.32,n.visible&&(r.opacity=e<.13?1:Math.max(0,(.32-e)/.19),i.forEach((t,n)=>{let r=a[n],i=e-r.time;t.visible=i>=0,t.visible&&(t.position.copy(r.position).addScaledVector(r.velocity,i),t.position.y-=i*i*1.2,t.scale.set(r.size,r.size*(1+Math.max(0,.04-i)*15),r.size))}))},dispose(){r.dispose(),n.clear()}}}var Ld=class{constructor(e,t){this.shared=e,this.sharedVideo=t,this.videoVersion=-1,this.sourceWidth=0,this.sourceHeight=0,this.targetWidth=0,this.targetHeight=0,this.ready=!1,this.order=[],this.disposed=!1,this.scene=new Jn,this.back=new Jn,this.camera=new Fo(-1,1,1,-1,.1,2e3),this.plane=new mi(new Ta(1,1),new ni({toneMapped:!1})),this.target=new un(1,1,{depthBuffer:!1}),this.maps=[],this.size=new U,this.ruptureGeometry=Fd(),this.slots=[],this.renderer=e??new Cu({alpha:!0,antialias:!0}),this.renderer.setPixelRatio(Math.min(devicePixelRatio,1.5)),this.renderer.outputColorSpace=et,this.renderer.setClearColor(0,0),this.target.texture.colorSpace=tt,this.camera.position.z=1e3,this.back.add(this.plane),this.scene.add(new vo(16777215,9931445,2));let n=new Lo(16777215,3);n.position.set(-2,3,4),this.scene.add(n)}async load(){let e=new go,t=`./assets/bubble-optical/`;for(let n of[`studio-environment.png`,`film-matcap.png`,`highlight-matcap.png`]){let r=await e.loadAsync(t+n);if(this.disposed){r.dispose();return}this.maps.push(r)}let[n,r,i]=this.maps;n.colorSpace=et,n.mapping=303,r.colorSpace=i.colorSpace=et,r.generateMipmaps=i.generateMipmaps=!0;let a=await new ju().loadAsync(t+`bubble.glb`),o=a.scene.getObjectByName(`Bubble_Shell`);if(a.scene.traverse(e=>{e instanceof mi&&((Array.isArray(e.material)?e.material:[e.material]).forEach(e=>e.dispose()),(this.disposed||e!==o)&&e.geometry.dispose())}),!this.disposed){this.geometry=o.geometry;for(let e=0;e<32;e++){let e=new mi(this.geometry,Nd({background:this.target.texture,environment:n,film:r,highlight:i}));e.updateMorphTargets();let t=Id(this.ruptureGeometry,n);this.scene.add(e,t.root),this.slots.push({mesh:e,rupture:t})}this.ready=!0}}draw(e,n,r,i){if(!this.ready||n<1||r<1||i.readyState<2||!e.some(e=>e.active))return!1;this.renderer.getSize(this.size);let a=this.renderer.getPixelRatio();(this.size.x!==n||this.size.y!==r)&&this.renderer.setSize(n,r);let o=Math.min(a,1280/n,720/r),s=Math.max(1,Math.round(n*o)),c=Math.max(1,Math.round(r*o));(this.targetWidth!==s||this.targetHeight!==c)&&(this.target.setSize(s,c),this.targetWidth=s,this.targetHeight=c,this.videoVersion=-1),(!this.videoTexture||this.videoTexture.image!==i)&&(this.sharedVideo||this.videoTexture?.dispose(),this.videoTexture=this.sharedVideo??new ga(i),this.videoTexture.colorSpace=et,this.plane.material.map=this.videoTexture,this.plane.material.needsUpdate=!0,this.videoVersion=-1),(this.sourceWidth!==i.videoWidth||this.sourceHeight!==i.videoHeight)&&(this.sourceWidth=i.videoWidth,this.sourceHeight=i.videoHeight,this.videoVersion=-1);let l=u(n,r,i.videoWidth,i.videoHeight),d=n>=r?1:n/(i.videoWidth*l),f=n>=r?1:r/(i.videoHeight*l);this.videoTexture.repeat.set(-d,f),this.videoTexture.offset.set((1+d)/2,(1-f)/2),(this.camera.right!==n/2||this.camera.top!==r/2)&&(this.camera.left=-n/2,this.camera.right=n/2,this.camera.top=r/2,this.camera.bottom=-r/2,this.camera.updateProjectionMatrix(),this.videoVersion=-1),this.plane.scale.set(n>=r?i.videoWidth*l:n,n>=r?i.videoHeight*l:r,1),this.videoTexture.update(),this.videoVersion!==this.videoTexture.version&&(this.renderer.setRenderTarget(this.target),this.renderer.clear(),this.renderer.render(this.back,this.camera),this.renderer.setRenderTarget(null),this.videoVersion=this.videoTexture.version);for(let e of this.slots)e.mesh.visible=!1,e.rupture.root.visible=!1;t(e,this.order);for(let t=0;t<this.order.length;t++){let i=this.order[t],o=this.slots[i],s=e[i];o.mesh.visible=s.pop<.06,o.mesh.position.set(s.x-n/2,r/2-s.y,t*.1),o.mesh.rotation.z=-(s.hitAngle??0),o.mesh.renderOrder=t,o.rupture.root.renderOrder=t;for(let e of o.rupture.root.children)e.renderOrder=t;let c=s.targetR?Math.sin(Math.PI*Math.min(1,s.age/.45))*.05:0;o.mesh.scale.set(s.r*(1-c),s.r*(1+c),s.r),o.mesh.morphTargetInfluences[0]=Math.min(1,Math.max(0,(s.squashAmount??0)/.08))*Math.sin(Math.PI*Math.min(1,Math.max(0,(s.squash??0)/.18))),Pd(o.mesh.material,s,n,r,a,s.birthOrder??i),o.rupture.root.position.copy(o.mesh.position),o.rupture.root.rotation.copy(o.mesh.rotation),o.rupture.root.scale.setScalar(s.r),o.rupture.update(s.pop)}return this.renderer.render(this.scene,this.camera),!0}dispose(){this.disposed||(this.disposed=!0,this.ready=!1,this.slots.forEach(e=>{e.mesh.material.dispose(),e.rupture.dispose()}),this.slots=[],this.geometry?.dispose(),this.ruptureGeometry.drop.dispose(),this.maps.forEach(e=>e.dispose()),this.maps=[],this.sharedVideo||this.videoTexture?.dispose(),this.plane.geometry.dispose(),this.plane.material.dispose(),this.target.dispose(),this.shared||this.renderer.dispose())}},Rd=class{constructor(e){this.renderer=new Cu({alpha:!0,antialias:!0}),this.disposed=!1,this.needsClear=!0,this.ready={confetti:!0,hearts:!1,bubble:!1},this.errors={},this.videoTexture=new ga(e),this.videoTexture.colorSpace=et,this.confetti=new Eu(this.renderer),this.hearts=new Ad(this.renderer),this.bubbles=new Ld(this.renderer,this.videoTexture),this.renderer.autoClear=!1,this.renderer.setClearColor(0,0)}async load(){for(let[e,t]of[[`hearts`,this.hearts],[`bubble`,this.bubbles]]){if(this.disposed)return;try{await t.load(),this.disposed||(this.ready[e]=!0)}catch{this.disposed||(t.dispose(),this.errors[e]=`素材加载失败`)}}}draw(e,t,n){let r=this.renderer,i=Math.min(devicePixelRatio,1.5);r.getPixelRatio()!==i&&(r.setPixelRatio(i),this.needsClear=!0),(r.domElement.width!==Math.floor(e.width*i)||r.domElement.height!==Math.floor(e.height*i))&&(r.setSize(e.width,e.height),this.needsClear=!0);let a=e.active>0,o=this.ready.hearts&&(t.hearts.some(e=>e.active)||!!t.heartPetals?.groups.some(e=>e.active)),s=this.ready.bubble&&t.bubbles.some(e=>e.active),c=a||o||s;!c&&!this.needsClear||(r.setRenderTarget(null),r.clear(),this.needsClear=c,a&&(r.toneMapping=0,this.confetti.draw(e)),o&&(r.clearDepth(),r.toneMapping=4,r.toneMappingExposure=1,this.hearts.draw(t.hearts,e.width,e.height,void 0,void 0,t.heartPetals)),s&&(r.clearDepth(),r.toneMapping=0,this.bubbles.draw(t.bubbles,e.width,e.height,n)))}dispose(){this.disposed||(this.disposed=!0,this.confetti.dispose(),this.hearts.dispose(),this.bubbles.dispose(),this.videoTexture.dispose(),this.renderer.dispose(),this.renderer.forceContextLoss())}};export{Rd as GiftRenderer};