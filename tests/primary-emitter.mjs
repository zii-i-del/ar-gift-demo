...
function run(kind,portrait,two){
 const e=new Interaction();e.reset();e.width=portrait?360:640;e.height=portrait?640:360;const births=[];
...
const mixed=new Interaction();mixed.reset();for(const t of [0,100,200,300]){mixed.acceptHands([hand('A','hearts'),hand('B','bubble')],t);mixed.step(.016,t);}assert(mixed.emittedHearts>0);assert.equal(mixed.emittedBubbles,0);
